...
const CARDS = {
  ...
  r7: [ ASSETS.earnings.A, ASSETS.earnings.B, ASSETS.earnings.C, ASSETS.earnings.D, ASSETS.earnings.E, ASSETS.earnings.F ], // V12 Fase 2 — earnings cards (A qull·B mirr·C noct·D spyr·E grin·F taro)
